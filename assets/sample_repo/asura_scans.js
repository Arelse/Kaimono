// Real working source backed by Asura Scans's official public API
// (https://https://api.asurascans.com/api) — built for third-party apps, no scraping.
const API = "https://api.asurascans.com/api";
const COVERS = "https://api.asurascans.com/api";
